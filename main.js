...
import saturnRingTexture from "./public/saturnRing.png";
import uranusTexture from "./public/uranus.jpg";
import uranusRingTexture from "./public/uranusRing.png";
...
function createOrbit(radius) {
  const orbitGeo = new THREE.RingGeometry(radius, radius + 0.1, 64);
